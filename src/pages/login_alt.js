...
function Login() {
  var styles=["cursor-pointer bg-white m-0 flex-1 text-center w-1/2 transition duration-300","cursor-pointer border-none bg-gray m-0 flex-1 text-center w-1/2 transition duration-300"];
       ...
       <Layout>
          <div className="mx-auto px-4 sm:px-8 min-h-screen">
             ...
             >
                ...
                className="m-0 pt-2 pb-2 text-xl leading-tight text-gray-900"
                id='Student'
                >Student</h2>
             </div>
             {error ? (
