            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              ...
              <div className="w-full md:w-1/2 px-3">
                ...
                <input className="appearance-none uppercase block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 "
                       ...
                       placeholder=""
                       onChange={props.onChange}
                       value={props.studentInput.rollNo}
                />
                { props.validateRollNo ?
                  <div>
                  <p className="my-2 text-xs text-red-700">
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                       ...
                       placeholder=""
                       onChange={props.onChange}
                       value={props.studentInput.contactNo}
                />
              ...
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                       ...
                       placeholder=""
                       onChange={props.onChange}
                       value={props.studentInput.emailID}
                />
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                       ...
                       placeholder=""
                       onChange={props.onChange}
                       value={props.studentInput.password}
                />
              ...
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                       ...
                       placeholder=""
                       onChange={props.onChange}
                       value={props.studentInput.confirmPassword}
                />
            ...
            <div className="flex flex-wrap -mx-3 mb-3">
              <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <div className="relative">
                  ...
                  value={props.studentInput.college}
              ...
              <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <div className="relative">
                {  props.isCollegeSelected ?
                  <select
                  className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                  id="department"
                  name="department"
                  value={props.studentInput.department}
              ...
              <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <div className="relative">
                  {
                    props.isDepartmentSelected ?
                    <select className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    id="class"
                    name="class"
                    value={props.studentInput.class}
                    onChange={props.onChange}
                    >
                          <option> </option>
                      {props.classes}
