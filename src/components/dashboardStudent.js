                        ...
                        <div className="flex flex-col items-left justify-center">
                            <form className="m-6 p-3">
                                <div className="flex flex-wrap -mx-3 mb-6 justify-center">
                                    <div className="md:w-1/6 px-1 mb-6 md:mb-0 flex-wrap flex justify-center items-center">
                                        <label className="uppercase text-gray-700 text-xs text-center font-bold" >
                                            Title
                                        </label>
                                    </div>
                                    <div className="md:w-5/6 mb-6 md:mb-0">
                                        <textarea onChange={handleTitleChange} className="block px-2 w-full" name = "title"/>
                                    </div>
                                </div>
                                <div className="flex flex-wrap -mx-3 mb-6 justify-center">
                                    <div className="md:w-1/6 px-1 mb-6 md:mb-0 flex-wrap flex justify-center items-center">
                                    ...
                                    <div className="md:w-5/6 mb-6 md:mb-0">
                                        <div>
                                            <textarea onChange={handleChange} className="block px-2 w-full" rows = "5"  name = "announcement"/>
                                        </div>
                                    </div>
                                </div>
