    ...
    if(props.data.length>0) {
        data = props.data.map((data, index) => {
            return (<VerticalTimelineElement
                ...
                date={<span
                    className="mx-3 font-medium text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl text-black">{data.time}</span>}
                iconStyle={{background: 'rgb(71, 75, 84)'}}
            >
                <div>
                    <div className="flex w-full justify-center items-center">
                        <div className="flex w-1/3 justify-center items-center">
                            <a className="px-2 py-1 bg-gray-700 hover:bg-gray-800 text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl text-green-100 rounded"
                               href="#">{data.courseCode}</a>
                        </div>
                    </div>
                    <div className="flex w-full justify-center items-center">
                    ...
                    <div className="flex w-full justify-between items-center mt-4">
                        <div className="flex w-1/2 items-center">
                            <a className="flex w-full items-center" href="#">
                                ...
                                <span
                                    className="ml-2 w-2/3 font-light text-xs sm:text-sm md:text-base lg:text-base xl:text-base text-gray-600">Resources</span>
                            </a>
                        </div>
                        <div className={"flex w-1/2 items-center"}>
                            <a className="flex w-full items-center justify-end" href="#">
                                <span
                                    className="w-2/3 mr-1 text-right font-light text-xs sm:text-sm md:text-base lg:text-base xl:text-base  text-gray-600">Messages</span>
                                <svg
